...
<template>
  <div class="p-2">
    ...
    <div class="carousel w-64">
      <BasketDessus class="carousel-item w-64" v-bind="basket" id="profil" />
      <BasketProfil class="carousel-item w-64" v-bind="basket" id="dessus" />
    </div>
    <FormKit type="form" v-model="basket">
      ...
      <FormKit name="oeillet" label="oeillets" value="#FFFFFF" type="radio":options="colors" />
      <FormKit name="lacet" label="lacets" value="#FFFFFF" type="radio":options="colors" />
